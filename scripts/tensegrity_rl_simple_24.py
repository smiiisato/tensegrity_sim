    ...
    if (args.what == "test") or args.resume:
        if args.trial is not None:
            ...
            if args.iter is not None:
                ...
                n_all_iter = len(rew_data.iloc[args.save_interval-5::args.save_interval])
                sorted_rew_data = (rew_data.iloc[args.save_interval-5::args.save_interval])[int(args.best_rate*n_all_iter):].sort_values(by="value")
